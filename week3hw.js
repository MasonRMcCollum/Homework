const pizzaToppings = ["pepperoni"," pineapple"," sausage"," pepper"];
...
getPizzaOrder(`Large`, `Stuffed crust` ,`pepperoni` ,`pineapple`, `sausage`, `pepper` );
...
servePizza(`Large`, `Stuffed crust` ,`pepperoni` ,`pineapple`, `sausage`, `pepper` )
